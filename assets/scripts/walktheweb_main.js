function WalkTheWeb() {
	...
	this.updateCols = function(zobj, zcols, zpage) {
		try {
			document.getElementById('walktheweb_tcols').value = zcols;
			document.getElementById('walktheweb_1col1').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_1col2').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_1col3').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_1col4').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_1col1').src = document.getElementById('walktheweb_1col1').src.replace('set.png','.png');
			document.getElementById('walktheweb_1col2').src = document.getElementById('walktheweb_1col2').src.replace('set.png','.png');
			document.getElementById('walktheweb_1col3').src = document.getElementById('walktheweb_1col3').src.replace('set.png','.png');
			document.getElementById('walktheweb_1col4').src = document.getElementById('walktheweb_1col4').src.replace('set.png','.png');

			document.getElementById('walktheweb_2col1').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_2col2').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_2col3').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_2col4').className = 'walktheweb_tinyimg';
			document.getElementById('walktheweb_2col1').src = document.getElementById('walktheweb_2col1').src.replace('set.png','.png');
			document.getElementById('walktheweb_2col2').src = document.getElementById('walktheweb_2col2').src.replace('set.png','.png');
			document.getElementById('walktheweb_2col3').src = document.getElementById('walktheweb_2col3').src.replace('set.png','.png');
			document.getElementById('walktheweb_2col4').src = document.getElementById('walktheweb_2col4').src.replace('set.png','.png');

			var zid1 = zobj.id.replace('walktheweb_2','walktheweb_1');
			var zid2 = zobj.id.replace('walktheweb_1','walktheweb_2');
			
			document.getElementById(zid1).className = 'walktheweb_tinyimgselected';
			document.getElementById(zid1).src = zobj.src.replace(zid1.replace('walktheweb_1','').replace('walktheweb_2','') + '.png', zobj.id.replace('walktheweb_1','').replace('walktheweb_2','') + 'set.png');
			document.getElementById(zid2).className = 'walktheweb_tinyimgselected';
			document.getElementById(zid2).src = document.getElementById(zid1).src;

			if (document.getElementById('walktheweb_tbuildingsearch') != null && zpage == 1) {
				walktheweb.buildingSearch(document.getElementById('walktheweb_tbuildingsearch').value);
			}
			if (document.getElementById('walktheweb_tcommunitysearch') != null && zpage == 2) {
				walktheweb.communitySearch(document.getElementById('walktheweb_tcommunitysearch').value);
			}
		} catch (ex) {
			walktheweb.serror("walktheweb_main.js-updateCols=" + ex.message);
		}
	}	
	...
	this.buildingSearchReply = function(zresponse) {
		...
		try {
			...
			for (var i=0; i < zresponse.length; i++) {
				...
				ztempsearchresults += "<div class=\"walktheweb_simplebox\">";
				ztempsearchresults += "<h3 class=\"walktheweb_black\">" + zresponse[i].templatename + "</h3>";
				...
				ztempsearchresults += "<input type='button' id='wtw_btempselect" + i + "' class='walktheweb_searchresultbutton' value='Select' onclick=\"walktheweb.selectBuilding('" + zbuildingid + "','" + zresponse[i].templatename + "','" + zresponse[i].imageurl + "');return (false);\" " + zbuttonstyle + " />";
	...
	this.communitySearchReply = function(zresponse) {
		...
		try {
			...
			for (var i=0; i < zresponse.length; i++) {
				...
				ztempsearchresults += "<input type='button' id='wtw_bcommtempselect" + i + "' class='walktheweb_searchresultbutton' value='Select' onclick=\"walktheweb.selectCommunity('" + zcommunityid + "','" + zresponse[i].templatename + "','" + zresponse[i].imageurl + "');\" " + zbuttonstyle + " />";
				ztempsearchresults += "<div style='white-space:normal;font-weight:normal;color:#000000;'>" + zresponse[i].description + "</div><br />";
				ztempsearchresults += "<div style='white-space:normal;font-weight:normal;color:#000000;'>Created By: <b>" + zresponse[i].displayname + "</b> (<b>" + zupdatedate + "</b>)</div><br />";
				ztempsearchresults += "<div style='white-space:normal;font-weight:normal;color:#000000;'>Downloaded: <b>" + zdownloads + "</b> times.</div><br />";
				if (zformat > 1) {
