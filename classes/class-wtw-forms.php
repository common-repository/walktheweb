	...
	public function walktheweb_menu() {
		...
		try {
			if (current_user_can('manage_options')) {
				...
				switch ($zpage) {
					case "walktheweb_downloadbuilding":
						add_submenu_page('walktheweb_menu', __('Marketplace', 'walktheweb'), __('Marketplace Downloads', 'walktheweb'), 'manage_options', 'walktheweb_downloadbuilding', array($this,'walktheweb_downloadbuilding_page'), 9);
						break;
					case "walktheweb_downloadthing":
						add_submenu_page('walktheweb_menu', __('Marketplace', 'walktheweb'), __('Marketplace Downloads', 'walktheweb'), 'manage_options', 'walktheweb_downloadthing', array($this,'walktheweb_downloadthing_page'), 9);
						break;
					case "walktheweb_downloadavatar":
						add_submenu_page('walktheweb_menu', __('Marketplace', 'walktheweb'), __('Marketplace Downloads', 'walktheweb'), 'manage_options', 'walktheweb_downloadavatar', array($this,'walktheweb_downloadavatar_page'), 9);
						break;
					default:
						add_submenu_page('walktheweb_menu', __('Marketplace', 'walktheweb'), __('Marketplace Downloads', 'walktheweb'), 'manage_options', 'walktheweb_downloadcommunity', array($this,'walktheweb_downloadcommunity_page'), 9);
						break;
				}
