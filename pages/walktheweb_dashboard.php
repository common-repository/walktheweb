...
<?php		} ?>
		...
		<div id="walktheweb_wizard" style="display:none;visibility:hidden;">
			...
			<div id="walktheweb_wizard1" class="walktheweb_dashboardpage" style="display:none;visibility:hidden;">
				...
				<div class="walktheweb_searchdiv">
					<div class="walktheweb_colicons">
						<img id="walktheweb_1col1" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col1.png" alt="1 Column" title="1 Column" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 1, 1);" />
						<img id="walktheweb_1col2" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col2set.png" alt="2 Columns" title="2 Columns" class="walktheweb_tinyimgselected" onclick="walktheweb.updateCols(this, 2, 1);" />
						<img id="walktheweb_1col3" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col3.png" alt="3 Columns" title="3 Columns" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 3, 1);" />
						<img id="walktheweb_1col4" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col4.png" alt="4 Columns" title="4 Columns" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 4, 1);" />
					</div>
				</div>
			...
			<div id="walktheweb_wizard2" class="walktheweb_dashboardpage" style="display:none;visibility:hidden;">
				...
				<div class="walktheweb_searchdiv">
					<div class="walktheweb_colicons">
						<img id="walktheweb_2col1" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col1.png" alt="1 Column" title="1 Column" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 1, 2);" />
						<img id="walktheweb_2col2" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col2set.png" alt="2 Columns" title="2 Columns" class="walktheweb_tinyimgselected" onclick="walktheweb.updateCols(this, 2, 2);" />
						<img id="walktheweb_2col3" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col3.png" alt="3 Columns" title="3 Columns" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 3, 2);" />
						<img id="walktheweb_2col4" src="<?php echo WTW_PLUGIN_URL; ?>/assets/images/col4.png" alt="4 Columns" title="4 Columns" class="walktheweb_tinyimg" onclick="walktheweb.updateCols(this, 4, 2);" />
					</div>
				</div>
...
<?php					} ?>
			...
			<div id="walktheweb_wizard5" class="walktheweb_dashboardpage" style="display:none;visibility:hidden;">
				...
				<div id="walktheweb_reviewdev">
					...
					<div style="margin-right:auto;margin-left:auto;min-width:680px;max-width:1000px;">
						<div class="walktheweb_hostingbox" style="width:600px;text-align:center;float:right;">
							<div class="walktheweb_createbutton" style="font-size:3em;" onclick="walktheweb.createIt();"><?php _e('Create It!', 'walktheweb' ); ?></div>
							<div style="clear:both;"></div><br /><br />
		...
		<input type='hidden' id='walktheweb_tcols' name='walktheweb_tcols' value='2' />
